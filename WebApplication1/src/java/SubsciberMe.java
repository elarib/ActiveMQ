...
public class SubsciberMe {
    ...
    public /*String*/void receiveMessage() {
        //String msg="";    
        try {
    ...
    public static void main(String[] args){
        SubsciberMe subsciberMe = new SubsciberMe();
        subsciberMe.receiveMessage();
        //System.out.println("Subscriber MSG : "+subsciberMe.receiveMessage());
    }
